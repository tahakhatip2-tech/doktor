...
export const BASE_CSS = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .stamp-clinic {
    font-size: 14px; font-weight: 900; color: #0284c7; text-transform: uppercase;
    letter-spacing: -0.2px;
  }
  .stamp-doctor {
    font-size: 11px; font-weight: 700; color: #0284c7; margin-top: 4px;
  }
  .stamp-date {
    font-size: 9px; font-weight: 600; color: #0284c7; margin-top: 2px;
  }
