...
export default function PharmacyRegisterScreen() {
  ...
  const onSubmit = async (data: FormData) => {
    setIsLoading(true);
    try {
      await pharmacyAuthApi.register(data);
      Alert.alert('نجاح', 'تم استلام طلب انضمام الصيدلية بنجاح! سيتم مراجعة حسابك', [
        { text: 'حسناً', onPress: () => router.push('/(auth)/pharmacy-login') }
      ]);
    } catch (e) {
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.glassCard}>
              <View style={styles.headerContainer}>
                ...
                <Text style={[styles.title, { fontFamily: 'Cairo-Bold' }]}>انضمام كصيدلية</Text>
                <Text style={[styles.subtitle, { fontFamily: 'Cairo-Regular' }]}>أدخل بيانات الصيدلية لطلب الانضمام</Text>
              </View>

              <View style={styles.formContainer}>
                <View style={styles.fieldWrapper}>
                  <Text style={[styles.label, { fontFamily: 'Cairo-SemiBold' }]}>اسم الصيدلية</Text>
                  <Controller
                    control={control}
                    name="name"
                ...
                <View style={styles.fieldWrapper}>
                  <Text style={[styles.label, { fontFamily: 'Cairo-SemiBold' }]}>العنوان</Text>
                  <Controller
                    control={control}
                    name="address"
                    render={({ field: { onChange, onBlur, value } }) => (
                  ...
                  />
                  {errors.address && <Text style={[styles.errorText, { fontFamily: 'Cairo-Regular' }]}>{errors.address.message}</Text>}
                </View>
                ...
                <View style={styles.registerContainer}>
                  <TouchableOpacity onPress={() => router.push('/(auth)/pharmacy-login')}>
