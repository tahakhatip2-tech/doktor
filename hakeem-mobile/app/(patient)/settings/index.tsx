...
export default function SettingsScreen() {
  ...
  const menuItems = [
    { id: 'profile', icon: 'person-outline', title: 'الملف الشخصي', color: colors.primary },
    { id: 'records', icon: 'document-text-outline', title: 'السجلات الطبية', color: colors.success },
    { id: 'prescriptions', icon: 'medical-outline', title: 'الوصفات الطبية', color: colors.info },
    { id: 'notifications', icon: 'notifications-outline', title: 'الإشعارات', color: colors.warning },
    { id: 'security', icon: 'shield-checkmark-outline', title: 'الأمان وكلمة المرور', color: colors.textSecondary },
    { id: 'help', icon: 'help-circle-outline', title: 'المساعدة والدعم', color: colors.textSecondary },
  ];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        <Text style={{ fontFamily: 'Cairo-Bold', fontSize: 24, color: colors.textMain, marginBottom: 24, textAlign: 'left' }}>الإعدادات</Text>
