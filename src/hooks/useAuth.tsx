...
export const useAuth = () => {
  ...
  // â”€â”€â”€ طھسجظٹل حساب جدظٹد (طبظٹب) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const signUp = async (
    email: string,
    password: string,
    ...
    // الطھحقق من طھطابق ظƒلمة المرظˆر ظپظٹ الـ Frontend أظٹضاً
    if (password !== confirmPassword) {
      return { error: 'ظƒلمة المرظˆر ظˆطھأظƒظٹد ظƒلمة المرظˆر ط؛ظٹر مطھطابقظٹن' };
    }

    try {
      await authApi.register({ email, password, confirmPassword, name, phone });
      // طھسجظٹل الدخظˆل الطھلقائظٹ بعد الطھسجظٹل
      return signIn(email, password);
    } catch (err: any) {
      return { error: err.message || 'حدث خطأ أثناط، إنشاط، الحساب' };
    }
  };

  // â”€â”€â”€ طھسجظٹل الدخظˆل â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const signIn = async (email: string, password: string) => {
    try {
      ...
      return { error: err.message || 'البرظٹد الإلظƒطھرظˆنظٹ أظˆ ظƒلمة المرظˆر ط؛ظٹر صحظٹحة' };
    }
  };

  // â”€â”€â”€ طھسجظٹل الخرظˆج â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const signOut = async () => {
    localStorage.removeItem('token');
    localStorage.removeItem('user');
    setUser(null);
